(self.webpackChunkmask_website = self.webpackChunkmask_website || []).push([
  [79],
  {
    2993: function (e) {
      ...
      function i(e, a) {
        ...
        if (e && a && "object" == typeof e && "object" == typeof a) {
          ...
          if (n && e instanceof Map && a instanceof Map) {
            ...
            for (l = e.entries(); !(u = l.next()).done; ) if (!i(u.value[1], a.get(u.value[0]))) return !1;
            return !0;
          }
          ...
          for (u = c; 0 != u--; ) if ((("_owner" !== s[u] && "__v" !== s[u] && "__o" !== s[u]) || !e.$$typeof) && !i(e[s[u]], a[s[u]])) return !1;
          return !0;
        }
        return e != e && a != a;
      }
    ...
    7823: function (e, t, n) {
      ...
      var r,
        ...
        _ = "titleTemplate",
        D = Object.keys(x).reduce(function (e, t) {
          return (e[x[t]] = t), e;
        }, {}),
            ...
            .reduce(function (e, n) {
              ...
              n.filter(function (e) {
                for (var n = void 0, i = Object.keys(e), a = 0; a < i.length; a++) {
                  var c = i[a],
                    u = c.toLowerCase();
                  -1 === t.indexOf(u) || (n === j && "canonical" === e[n].toLowerCase()) || (u === j && "stylesheet" === e[u].toLowerCase()) || (n = u),
                    -1 === t.indexOf(c) || (c !== O && c !== v && c !== C) || (n = c);
                }
                if (!n || !e[n]) return !1;
        ...
        ce = function (e, t) {
          void 0 !== e && document.title !== e && (document.title = ae(e)), ue(T.TITLE, t);
        },
        ue = function (e, t) {
          var n = document.getElementsByTagName(e)[0];
          if (n) {
            for (var r = n.getAttribute(B), o = r ? r.split(",") : [], i = [].concat(o), a = Object.keys(t), c = 0; c < a.length; c++) {
              var u = a[c],
                s = t[u] || "";
            ...
            case T.TITLE:
              return {
                toComponent: function () {
                  return (e = t.title), (n = t.titleAttributes), ((r = { key: e })[B] = !0), (o = fe(n, r)), [c.createElement(T.TITLE, o, e)];
                  var e, n, r, o;
                },
                toString: function () {
                  return (function (e, t, n, r) {
                    var o = le(n),
                      i = ae(t);
                    return o
                      ? "<" + e + ' data-react-helmet="true" ' + o + ">" + V(i, r) + "</" + e + ">"
                      : "<" + e + ' data-react-helmet="true">' + V(i, r) + "</" + e + ">";
        ...
        me = f()(
          function (e) {
            return {
              ...
              encode: Q(e, M),
              htmlAttributes: $(b, e),
              linkTags: J(T.LINK, [j, E], e),
              metaTags: J(T.META, [S, w, A, k, C], e),
              noscriptTags: J(T.NOSCRIPT, [O], e),
              onChangeClientState: G(e),
              scriptTags: J(T.SCRIPT, [P, O], e),
              styleTags: J(T.STYLE, [v], e),
              title: W(e),
              titleAttributes: $(g, e),
            };
          },
              ...
              return (
                    ...
                    c.Children.forEach(e, function (e) {
                      if (e && e.props) {
                        ...
                        switch ((n.warnOnInvalidChildren(e, i), e.type)) {
                          ...
                          case T.SCRIPT:
                          case T.STYLE:
                            r = n.flattenArrayTypeChildren({ child: e, arrayTypeChildren: r, newChildProps: a, nestedChildren: i });
                            break;
                          default:
                            t = n.mapObjectTypeChildren({ child: e, newProps: t, newChildProps: a, nestedChildren: i });
                        }
                      }
                    }),
                ...
                (t.prototype.render = function () {
                  var e = this.props,
                    ...
                    n = z(e, ["children"]),
                    r = U({}, n);
                  return t && (r = this.mapChildrenToProps(t, r)), c.createElement(o, r);
                }),
                F(t, null, [
                  {
                    key: "canUseDOM",
      ...
      function ye(e) {
        return c.createElement(
          ...
          c.createElement("meta", { name: "viewport", content: "width=device-width, initial-scale=1.0, maximum-scale=1.0, user-scalable=no" }),
          c.createElement("meta", { name: "description", content: "The Portal to the New, Open Internet." }),
          c.createElement("meta", { name: "author", content: "Mask Network" }),
          c.createElement("meta", { name: "application-name", content: "Mask Network" }),
          c.createElement("meta", { property: "og:title", content: "Mask Network — The Portal to the New, Open Internet." }),
          c.createElement("meta", { property: "og:type", content: "website" }),
          c.createElement("meta", { property: "og:image", content: "/fb-share-banner.png" }),
          c.createElement("meta", { property: "og:url", content: "https://mask.io" }),
          c.createElement("meta", { property: "og:description", content: "The Portal to the New, Open Internet." }),
          c.createElement("meta", { property: "fb:app_id", content: "321539018508290" }),
          c.createElement("meta", { name: "twitter:card", content: "summary" }),
          c.createElement("meta", { name: "twitter:title", content: "Mask Network — The Portal to the New, Open Internet." }),
          c.createElement("meta", { name: "twitter:description", content: "The Portal to the New, Open Internet." }),
          c.createElement("meta", { name: "twitter:image", content: "/apple-touch-icon.png" }),
          c.createElement("meta", { name: "apple-itunes-app", content: "app-id=1478382964" }),
          c.createElement("title", null, "Mask Network"),
          c.createElement(
            "script",
          ...
          c.createElement("script", { async: !0, src: "https://www.googletagmanager.com/gtag/js?id=G-2XCS4Y99TG" }),
          c.createElement("title", null, e.title),
          c.createElement("link", { rel: "shortcut icon", href: "/favicon.ico" })
        );
      }
    },
  },
]);
//# sourceMappingURL=1f9632dcf2737129b7a3e943b87b0764e5d29b40-af98db1df372960244e1.js.map
